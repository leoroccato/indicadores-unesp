...
BASE_XLSX = (APP_DIR / "Application" / "Python" / "pdfExtractor" / "saida" / "base.xlsx").resolve()
FORM_XLSX = (APP_DIR / "Application" / "Python" / "pdfExtractor" / "saida" / "formandos.xlsx").resolve()
